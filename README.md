...
**[Hello React Frontend]** is an app with a rails backend.

click here to view the [backend code](https://github.com/Reggeditt/hello-rails-back-end)
...
- **[Shows random greeting from the API endpoint]**
...
```
git clone https://github.com/Reggeditt/hello-react-frontend.git
```
### Install
